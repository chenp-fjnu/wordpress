...
<!-- You can start editing here. -->
	...
	<?php if ( have_comments() ) { ?>
		<div id="comments-div">
		<h2 id="comments">评论数:<?php comments_number('0', '1', '%' );?></h2>
		<?php if ( comments_open() ) { ?><span id="comments-addcomment">
		<a href="#respond"  rel="nofollow" title="吐糟">
		+1</a></span><?php } ?></div>
	...
	<?php } else { // this is displayed if there are no comments so far ?>
		<?php if ( comments_open() ) { ?>
			<div id="comments-div"><?php if ( comments_open() ) { ?><span id="comments-addcomment">
			<a href="#respond"  rel="nofollow" title="<?php _e('Leave a comment ?', 'zbench'); ?>">
			<?php _e('Leave a comment ?', 'zbench'); ?></a></span><?php } ?>
			<h2 id="comments"><?php _e('Comments.','zbench'); ?><?php comments_number('0', '1', '%' );?> </h2></div>
