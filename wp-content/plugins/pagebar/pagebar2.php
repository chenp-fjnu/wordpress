...
function pagebar_addConfigureLink( $links ) {  // add Settings link to plugin page
  $settings_link = '<a href="options-general.php?page=pagebar_options.php">'. __('Settings', 'pagebar').'</a>';
...
add_action( 'plugins_loaded', 'pagebar_load_textdomain' );
function pagebar_load_textdomain() {
